		...
		<div class="row">
			<div class="col-lg-4" style="background-color: lightgrey">
				<div class="text-center no-margin">
					<img src="https://scontent.fcgk13-1.fna.fbcdn.net/v/t1.0-9/45054138_2094035533950233_8914367874554920960_n.jpg?_nc_cat=111&_nc_ht=scontent.fcgk13-1.fna&oh=d6154665db20318f9e1d9aaa811dfeff&oe=5C4B34CD" class="img-border">
					<h1 class="centered text-grey">running</h1>
				</div>
			</div>
			<div class="col-lg-4" style="background-color: lightgrey">
				<div class="text-center no-margin">
					<img src="https://scontent.fcgk13-1.fna.fbcdn.net/v/t1.0-9/45146923_2094035500616903_6979559075633692672_n.jpg?_nc_cat=110&_nc_ht=scontent.fcgk13-1.fna&oh=faa4a1c36a9518b8d023c7535f075e81&oe=5C7E352F" class="img-border">
					<h1 class="centered text-grey">casuals</h1>
				</div>
			</div>
			<div class="col-lg-4" style="background-color: lightgrey">
				<div class="text-center no-margin">
					<img src="https://scontent.fcgk13-1.fna.fbcdn.net/v/t1.0-9/44933250_2094035643950222_2919941590724116480_n.jpg?_nc_cat=104&_nc_ht=scontent.fcgk13-1.fna&oh=faa5c1e03f7991cfdddab14cab3326fe&oe=5C3E0242" class="img-border">
					<h1 class="centered text-grey text-block">basketball</h1>
				</div>
			</div>
		</div>
	</div>
	<div class="text-center">
		<button onclick="window.location.href='allshoesin.php'" class="button bayang">see all shoes</button>
	</div>
	<div class="footer">
